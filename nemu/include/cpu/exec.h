...
// IDEX (0x89, mov_G2E, mov) = CASE_ENTRY(0x89, decode_mov_G2E, exec_move, NULL) = case 0x89: set_width(s, NULL); decode_mov_G2E(s); exec_move(s); break;
// decode_xxx => please see decode.h and $ISA/local-include/decode.h
// id是命令名,需要译码，ex是执行方法
