...
// def_rtl_compute_reg(add) def_rtl_computer_imm(add)
// def_rtl(add, rtlreg_t* dest, const rtlreg_t* src1, * src2) => rtl_add(s, dest, src1, src2) {c_add()}
// def_rtl(addi, *dest, src1, imm) => rtl_addi(s, dest, src1, imm)
